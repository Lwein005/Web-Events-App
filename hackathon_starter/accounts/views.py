...
def api_examples(request):
    ...
    return render(request, 'accounts/api_examples.html', context)
...
def facebook(request):
    ...
    '''
    userInfo = getFacebook.get_user_info()
    return render(request, 'accounts/facebookAPIExample.html', { 'userInfo' : userInfo})
...
def googlePlus(request):
    ...
    userInfo = getGoogle.get_user_info()
    return render(request, 'accounts/googlePlus.html', {'userInfo' : userInfo})
...
def dropbox(request):
    userInfo = getDropbox.get_user_info()
    return render(request, 'accounts/dropbox.html', {'userInfo' : userInfo})
...
def dropboxSearchFile(request):
    if request.method == 'POST':
        ...
        return render(request, 'accounts/dropboxSearchFile.html', {'data': response.json()})
...
def foursquare(request):
    userInfo = getFoursquare.get_user_info()
    return render(request, 'accounts/foursquare.html', {'data' : userInfo})
...
def meetup(request):
    REDIRECT_URI = 'http://127.0.0.1:8000/accounts/meetupToken'
...
def meetupToken(request):
    ...
    return HttpResponseRedirect('http://127.0.0.1:8000/accounts/meetupUser/')

def meetupUser(request):
    if not MeetupToken.objects.all().exists():
        return HttpResponseRedirect('http://127.0.0.1:8000/accounts/meetup')
    ...
    return render(request, 'accounts/meetup.html', { 'data': meetupData })
...
def quandlstocks(request):
    ...
    return render(request, 'accounts/quandl.html', { 'everyData': everyData })
...
def nytimesarticles(request):
    ...
    return render(request, 'accounts/nytimes.html', { 'everyData': everyData })
...
def githubUser(request):
    ...
    return render(request, 'accounts/github.html', {'data': parsedData})
...
def githubTopRepositories(request):
    ...
    if request.method == 'POST':
        ...
        print parsedData
    return render(request, 'accounts/githubTopRepositories.html', {'data': parsedData})
...
def githubResume(request):
    ...
    return render(request, 'accounts/githubResume.html', { 'data': allData })
...
def tumblr(request):
    ...
    return render(request, 'accounts/tumblr.html', context)
...
def instagram(request):
    ...
    return render(request, 'accounts/instagram.html', context)
...
def instagramMediaByLocation(request):
    ...
    return render(request, 'accounts/instagram_q.html', context)
...
def twitter(request):
    ...
    return render(request, 'accounts/twitter.html', context)
...
def twitterTweets(request):
    ...
    return render(request, 'accounts/twitter_tweet.html', context)
...
def linkedin(request):
    ...
    return render(request, 'accounts/linkedin.html', context)
...
def twilio(request):
    if request.method == 'POST':
        ...
        return HttpResponseRedirect('/accounts/api/')
    return render(request, 'accounts/twilio.html')
